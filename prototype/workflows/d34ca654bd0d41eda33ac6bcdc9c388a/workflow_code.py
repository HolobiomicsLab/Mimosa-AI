...
class SmolAgentFactory:
    ...
    def __init__(self, instruct_prompt, tools, model_id="deepseek-ai/DeepSeek-Prover-V2-671B", engine_name="hf_api", max_steps=10):
        self.model_id = model_id
        self.max_tokens = 1024
        self.provider = "novita"
        self.token = os.getenv("HF_TOKEN")
...
path_json = os.path.join("workflows/d34ca654bd0d41eda33ac6bcdc9c388a/", "state_result.json")
try:
    with open(path_json, "w") as f:
        json.dump(result_state, f, indent=2)
except Exception as e:
