...
class SmolAgentFactory:
    ...
    def __init__(self, instruct_prompt, tools, model_id="mistralai/Mixtral-8x22B-Instruct-v0.1", engine_name="hf_api", max_steps=10):
        self.model_id = model_id
        self.max_tokens = 1024
...
path_json = os.path.join("workflows/b72dbe3935ed4c44a3b556588003763e/", "state_result.json")
try:
    with open(path_json, "w") as f:
        json.dump(result_state, f, indent=2)
except Exception as e:
