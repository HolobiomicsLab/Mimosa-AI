...
> **Objective** — Reproduce [Nothias et al. (2018)](https://doi.org/) end-to-end: from feature detection through network visualization, starting from `.mzML` files (raw data conversion assumed complete).

Mimosa-AI was given the paper, the raw data, and a set of domain-specific skills covering configuration details not fully specified in the publication — a common gap that makes reproducibility hard in practice.
...
![Molecular network generated by Mimosa-AI](./docs/images/network.jpg)
