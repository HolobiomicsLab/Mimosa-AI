...
- **Minimum 2+ agents** for any non-trivial task to ensure proper decomposition
...
- [ ] **Minimum 3+ specialized agents** for complex tasks (extract → validate → format)
...
- [ ] **Minimum 3+ agents** demonstrating proper task decomposition
