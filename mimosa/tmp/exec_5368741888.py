...
initial_state = {
    "workflow_uuid": "459042e7893742b4ad9d00a96ca3ab13",
    "step_name": [],
    "step_uuid": [],
    "actions": [],
    "observations": [],
...
try:
    if "":
        ...
        try:
            ...
            with open(os.path.join("", "workflow_459042e7893742b4ad9d00a96ca3ab13.png"), "wb") as f:
                f.write(png)
        except Exception as e:
...
if "":
    ...
    try:
        with open(os.path.join("", "state_result_459042e7893742b4ad9d00a96ca3ab13.json"), "w") as f:
