...
class SharedVisualizationData:
    ...
    def _safe_read_json(self, filepath: Path) -> Optional[Dict[str, Any]]:
    ...
    def write_curve_data(
        ...
        data = {
            ...
            "metadata": {
                "start_time": time.time() if not process_file.exists() else self._get_start_time(process_id),
    ...
    def get_summary_stats(self) -> Dict[str, Any]:
        ...
        completed_count = sum(1 for data in all_data.values() 
        ...
        return {
            ...
            "total_iterations": sum(len(data.get("curve_data", {}).get("iterations", [])) 
                                  for data in all_data.values())
        }
...
class ParallelPlotManager:
    ...
    def start_real_time_plotting(self, title: str = "Parallel Processes - Rewards Curves") -> None:
        ...
        with self._lock:
            ...
            for process_id, data in all_data.items():
                ...
                if iterations and rewards:
                    ...
                    ax.plot(iterations, rewards, style, 
