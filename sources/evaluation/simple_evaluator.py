...
"""
    ...
    def _save_results(self, workflow_id: str, scenario_id: str, 
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Evaluate Mimosa-AI workflows")
    parser.add_argument("--workflow_id", required=True, 
                        help="UUID of workflow to evaluate")
    parser.add_argument("--scenario", required=True, 
                        help="Evaluation scenario ID")
    ...
    try:
        ...
        if args.verbose:
            ...
            print(f"Assertions: {results['passed_assertions']}/"
